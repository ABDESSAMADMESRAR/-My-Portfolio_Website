...
function Contact() {
  ...
  useEffect(() => {
    ...
    sr.reveal(`.Portfolio2`, {
    
      origin: "bottom",
    });
    sr.reveal(`#Me`, { origin: "left"   });
    sr.reveal(`#contact__card1`, { origin: "top" });
    sr.reveal(`#contact__card2`, { origin: "top" });
    sr.reveal(`#contact__card3`, { origin: "bottom" });
    sr.reveal(`#Talk`, { origin: "top" });
    sr.reveal(`#Write`, { origin: "top" });
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_o7we0yb', 'template_17ia9rf', form.current, {
        publicKey: 'bWyW3cn3EIGZosUfq',
      })
    e.target.reset()
  };
        ...
        <div className="contact_content" >
          ...
          <div className="contact__info">
            ...
            <i class="ri-mail-line contact__card-icon"></i>
              ...
              <span className="contact__card-date">abdsamad.mesrar.9@gmail.com
</span>

              <a href="mailto:abdsamad.mesrar.9@gmail.com" className="contact__button">Write me <i class="ri-arrow-right-circle-fill contact_button-icon  "></i></a>
            </div>
            ...
            <i class="ri-whatsapp-line contact__card-icon"></i>
              ...
              <a href="https://api.whatsapp.com/send/?phone=2120626249432&text&type=phone_number&app_absent=0" className="contact__button">Write me <i class="ri-arrow-right-circle-fill contact_button-icon  "></i></a>
            </div>
              {/* contact__card3 */}
              <div className="contact__card" id='contact__card3'>
              <i class="ri-twitter-x-line contact__card-icon"></i>
              <h3 className="contact__card-title">twitter</h3>
              <span className="contact__card-date">@ABDESSAMAD51194</span>

              <a href="https://twitter.com/ABDESSAMAD51194" className="contact__button">Write me <i class="ri-arrow-right-circle-fill contact_button-icon  "></i></a>
            </div>
